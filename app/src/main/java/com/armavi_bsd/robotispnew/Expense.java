...
import com.armavi_bsd.robotispnew.adapter.ExpenseRVAdapter;
import com.armavi_bsd.robotispnew.adapter.ListViewAdapter;
import com.armavi_bsd.robotispnew.urlStorage.URLStorage;
import com.armavi_bsd.robotispnew.databinding.ActivityExpenseBinding;
import com.armavi_bsd.robotispnew.httpParser.HttpParseClass;
import com.armavi_bsd.robotispnew.model.ExpenseModel;
import com.armavi_bsd.robotispnew.model.ProfileView;
import com.armavi_bsd.robotispnew.model.Subjects;
import com.armavi_bsd.robotispnew.model.UserView;
...
//                diag_exp_name = (TextView) bootmSheetView.findViewById(R.id.diag_exp_id);
                ...
                diagInsertBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        } else if(diag_exp_sub_head.getText().toString().isEmpty()){
                            decoratedDialog("Some Field is empty !");
                            ...
                            final StringRequest stringRequest = new StringRequest(Request.Method.POST, request_url,
                                    new Response.Listener<String>() {
                                        ...
                                        public void onResponse(String response) {
                                            Toast.makeText(Expense.this, response.toString(), Toast.LENGTH_LONG).show();
            ...
            public void onResponse(JSONArray response) {
                ...
                for(int i = 0; i < response.length(); i++){
                    ...
                    try {
                        ...
                        personUtils.setAcc_name(jsonObject.getString("acc_head_name"));
                        personUtils.setAcc_head(jsonObject.getString("acc_head"));
                        ...
                        personUtils.setEntry_date(jsonObject.getString("entry_date"));
                        personUtils.setEntry_by(jsonObject.getString("entry_by"));
                        personUtils.setAcc_id(jsonObject.getString("acc_id"));
                        personUtils.setAcc_sub_head(jsonObject.getString("acc_sub_head"));
                        personUtils.setAcc_sub_head_name(jsonObject.getString("acc_sub_head_name"));

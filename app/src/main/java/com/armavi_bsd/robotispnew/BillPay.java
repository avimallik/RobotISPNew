...
import com.armavi_bsd.robotispnew.adapter.AgentAdapter;
import com.armavi_bsd.robotispnew.adapter.BillCollectionAdapter;
import com.armavi_bsd.robotispnew.databinding.ActivityBillPayBinding;
import com.armavi_bsd.robotispnew.model.AgentModel;
import com.armavi_bsd.robotispnew.model.BillCollectionModel;
import com.armavi_bsd.robotispnew.retroFitClient.RretrofitClient;
import com.armavi_bsd.robotispnew.viewModel.AgentViewModel;
import com.armavi_bsd.robotispnew.viewModel.BillCollectionViewModel;
...
public class BillPay extends AppCompatActivity {
    ...
    private void filterBills(String query) {
        ...
        for (BillCollectionModel billCollection : allBills) {
            if (billCollection.getAg_name().toLowerCase().contains(query.toLowerCase())
                    || billCollection.getAg_mobile_no().contains(query)
                    || billCollection.getZone_name().toLowerCase().contains(query.toLowerCase())
